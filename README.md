...
| 맵 이동 · 야생 조우 | 턴제 전투 |
| :---: | :---: |
| <img src="docs/images/map.png" width="100%"/> | <img src="docs/images/battle-dual-type-burn.png" width="100%"/> |
| 맵을 이동하다 확률적으로 야생 포켓몬과 조우 | 야돈의 **에스퍼+물 이중 타입**과 **화상** 상태이상 |
...
| | |
| --- | --- |
| **기간 · 인원** | 2026.03 · 팀 프로젝트 4명 (에이콘아카데미) |
| **규모** | 24개 클래스 · 약 3,560줄 |
...
<div align="center">
<img src="docs/images/battle-skill-select.png" width="620"/>

<sub>기술 선택 시 <b>타입과 위력</b>을 함께 노출 — 위 계산식의 입력값을 플레이어가 보고 판단할 수 있게 했습니다.</sub>
</div>
...
<div align="center">
<img src="docs/images/battle-log.png" width="700"/>

<sub>키를 통일한 뒤 — 불 기술이 물/에스퍼 타입 야돈에게 <b>「효과가 별로인 듯하다…」</b>로 상성 배율이 정상 적용되는 모습.<br/>화상 상태의 턴 종료 데미지도 함께 확인됩니다.</sub>
</div>
...
<!--
비주얼 현황 (2026-07-17):
  [x] 맵 이동          → docs/images/map.png
  [x] 전투 화면        → docs/images/battle-dual-type-burn.png (이중타입 + 화상)
  [x] 기술 선택        → docs/images/battle-skill-select.png
  [x] 타입 상성 로그   → docs/images/battle-log.png
  [ ] 레벨업 / 진화 연출 순간
  [ ] GIF: 야생 조우 → 기술 선택 → 데미지 → 승리 한 사이클
  ※ 스타터 선택 / 인트로 컷은 로그창 위주라 히어로엔 부적합해 미채택 (원본은 AJ_Proj/_캡처검토_pokemonJava/에 보관)
